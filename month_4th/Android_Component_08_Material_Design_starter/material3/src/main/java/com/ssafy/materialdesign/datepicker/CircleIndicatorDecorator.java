...
class CircleIndicatorDecorator extends DayViewDecorator {
  ...
  private static class IndicatorDrawables {
    ...
    private IndicatorDrawables(Context context) {
      ...
      indicatorMarginBottom = resources.getDimensionPixelOffset(R.dimen.cat_picker_demo_circle_indicator_margin_bottom);
      int topSpacerSize = resources.getDimensionPixelSize(R.dimen.cat_picker_demo_circle_indicator_top_spacer_size);
      int indicatorColorDefault = MaterialColors.getColor(context, R.attr.colorTertiary, IndicatorDrawables.class.getSimpleName());
      int indicatorColorSelected = MaterialColors.getColor(context, R.attr.colorOnPrimary, IndicatorDrawables.class.getSimpleName());
  ...
  public static final Creator<CircleIndicatorDecorator> CREATOR =
      new Creator<CircleIndicatorDecorator>() {
        @NonNull
        @Override
